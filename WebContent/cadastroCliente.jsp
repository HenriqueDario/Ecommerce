        ...
        <h1 class="titulo"> Crie sua conta </h1>
 		<form action="cadastrar" id="formCadastro" method="POST" enctype="multipart/form-data" class="formularioCadastroCliente">
            ...
            <table class="campos-cadastro">
                ...
                <tr>
                 	<td><input type="text" id="nome-cliente" name="txtNome" class="coluna" required></td>
                    <td><input maxlength="14" type="text" id="cpf" name="txtCpf" class="coluna" required onkeydown="fMasc(this, mCPF );" onblur="validarCPF(this)"></td>
                </tr>
                <tr>
                 	<th>
                 		<label class="coluna">
                ...
                <tr>
                	<td>
                   		<input type="text" id="txt-email" name="txtEmail" required>
                	</td>
                </tr>
				<tr>
					<th>
			...
			<br>   <input type="file" name="file" id="file" style="margin-top: 2em; margin-bottom:1em;"> 	
            
            <br>   <input type="button" value="Cadastrar" id="btn-cadastrar" onclick="cadastrar()">
