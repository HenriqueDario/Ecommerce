...
<html>
    ...
    <body>
        ...
        <form class="formularioLogin" id="formularioLogin" name="formularioLogin" method="post" action="login">
            ...
            <input type="button" value="Login" class="btn-login" onclick="logar()">
