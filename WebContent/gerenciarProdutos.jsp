...
<body>
	...
	<form action="productSearch" method="GET" class="searchProduct"
	...
	<a href="cadastroProduto.jsp"><input type="button"
		class="btnNovoProduto" id="btnNovoProduto" name="btnNovoProduto"
		value="Adicionar Produto"></a>
