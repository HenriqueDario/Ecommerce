...
<body>
	...
	<h1 class="titulo">
		Obrigado pela compra!! <br> <br>

	</h1>
	<p class="sub-tituloo !important">Produtos Comprados:</p>
	<br>
	<table class="gerenciarProduto">
		...
		<c:forEach var="product" items="${ListaCompra}">
			<tr>
				...
				<td>Quantidade: ${product.quantityShoppingCart}</td>
			</tr>
		</c:forEach>
	</table>
	<a href="index.jsp"> <input type="button" value="Voltar"
		class="btnVoltar"></a>
