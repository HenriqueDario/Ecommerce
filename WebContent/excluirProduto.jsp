...
<body>
	...
	<form action="deleteProduct" id="formDeleteProduct"
		name=formDeleteProduct method="post" class="excluirConta">
		...
		<input type="button" id="btn-enviar" name="btn-enviar" value="Enviar"
			onclick="validar()"> <input type="hidden" id="idProduct"
			name="idProduct"
			value="<%out.print(request.getParameter("idProduct"));%>">
	</form>
